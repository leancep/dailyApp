...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope-fill"></i><a href="mailto:contact@example.com">leanceps2@gmail.com</a>
        <i class="bi bi-phone-fill phone-icon"></i> +54 11 67834985
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="#">Leandro Cepeda</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
           <!-- Languages dropdown    -->
           <!-- <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="asd" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><span class="d-none d-sm-inline-block">{{ trans('messages.idiomas') }}</span></a>
                <div aria-labelledby="languages" class="dropdown-menu">
                    <a rel="nofollow" href="{{ url('lang', ['en']) }}" class="dropdown-item"> <img src="{{ asset('img/flags/16/GB.png') }}" alt="English" class="mr-2"><span>English</span></a>
                    <a rel="nofollow" href="{{ url('lang', ['es']) }}" class="dropdown-item"> <img src="{{ asset('img/flags/16/ES.png') }}" alt="Spanish" class="mr-2"><span>Spanish</span></a>
                </div>
          ...
          <li class="dropdown"><a href="#"><span>{{ trans('messages.lenguaje') }}</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{route('set_language','en')}}">{{ trans('messages.ingles') }}</a></li>
              <li><a href="{{route('set_language','es')}}">{{ trans('messages.español') }}</a></li>
            </ul>
          </li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      <h1>{{ trans('messages.msgBienvenida') }}</h1>
      <h2>{{ trans('messages.appsdiarias') }}</h2>
    ...
    <div class="apps-top">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="apps-info">
              ...
              <p>
                 <br>
                 {{ trans('messages.msgDolar') }}<br><br>
                
               
               
                <div class="row">
                    <div class="col-sm-6">
                      <strong>{{$dolares[0]->casa->nombre}}</strong><br>
                      <strong>{{ trans('messages.compra') }} </strong>{{$dolares[0]->casa->compra}}<br>
                      <strong>{{ trans('messages.venta') }}</strong>{{$dolares[0]->casa->venta}}<br>
                    </div>
                    <div class="col-sm-6">
                      <strong>{{$dolares[1]->casa->nombre}}</strong><br>
                      <strong>{{ trans('messages.compra') }}</strong> {{$dolares[1]->casa->compra}}<br>
                      <strong>{{ trans('messages.venta') }}</strong> {{$dolares[1]->casa->venta}}<br>
                    </div>
                  </div>
          ...
          <div class="col-lg-6 col-md-6">
            <div class="apps-info">
              ...
              <p>
                 <br>
                 {{ trans('messages.msgCripto') }}<br><br>
                
               
               
                <div class="row">
                  <div class="col-sm-4">
                      <strong>{{$cripto[0]->name}}</strong><br>
                      <strong>{{ trans('messages.precio') }} </strong><br>{{$cripto[0]->current_price}}<br>
                      
                    </div>
                    <div class="col-sm-4">
                      <strong>{{$cripto[1]->name}}</strong><br>
                      <strong>{{ trans('messages.precio') }} </strong><br>{{$cripto[1]->current_price}}<br>
                    </div>
                    <div class="col-sm-4">
                      <strong>{{$cripto[2]->name}}</strong><br>
                      <strong>{{ trans('messages.precio') }} </strong><br>{{$cripto[2]->current_price}}<br>
                    </div>
                  </div>
      ...
      <!--<a href="#about" class="btn-get-started scrollto">Dolar Hoy!</a>-->
      </div>
    </div> 
  </section><!-- End Hero -->
 ...
 <!--<section id="about" class="about">
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Cepeda</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
